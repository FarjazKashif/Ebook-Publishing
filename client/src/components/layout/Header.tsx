...
export const Header = () => {
    ...
    const [isMobileServicesOpen, setIsMobileServicesOpen] = useState(false); // State for mobile dropdown
    ...
    return (
        <>
            <header className={`site-header ${isScrolled ? 'scrolled' : ''}`} id="siteHeader">
                <div className="container header__inner">
                    ...
                    <nav className="main-nav" aria-label="Primary">
                        ...
                        {/* Original CSS Dropdown Structure */}
                        <div className="nav-dropdown">
                          {/* Using an anchor with preventDefault so it doesn't navigate, just opens the CSS hover dropdown */}
            ...
            <div className={`mobile-drawer ${isMenuOpen ? 'is-open' : ''}`}>
                ...
                {/* Mobile Expanding Services Dropdown */}
                <button 
